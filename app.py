...
for _, obj in enumerate(lista_simple):
    print("-"*25)
    print("Quien quiere retirar del curso?")
    value=input("")
    print("curso")
    curso=int(input(""))
    obj.Lista_matriculados.delete_node_Matriculados(value,curso)
    lista_simple.head.Lista_matriculados.check_if([obj.Lista_espera.getHead(),curso], lista_simple.head)
    obj.Lista_espera.delete_node_Espera(curso)
